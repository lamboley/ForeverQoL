...
local function DepositListedItems()
    ...
    for bagID = 0, NUM_BAG_SLOTS do
        for slot = 1, C_Container.GetContainerNumSlots(bagID) or 0 do
            ...
            local containerInfo = itemID and ForeverQoLData.Configs.AutoDepositItemList[itemID]
                and not ForeverQoLData.Configs.AutoSellItemList[itemID]
                and C_Container.GetContainerItemInfo(bagID, slot)
